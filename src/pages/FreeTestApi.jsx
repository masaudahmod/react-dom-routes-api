        ...
        {loading ? (
            ...
            <div className="flex flex-wrap justify-between">
                {allUser.map((user) => (
                    <div 
                        key={user.id} 
                        className={`border-2 text-black mb-6 p-4 w-full sm:w-[48%] md:w-[31%] rounded-xl ${user.age <= 25 ? "border-red-600" : "border-emerald-600"} ${user.age <= 25 ? "bg-red-200" : "bg-emerald-200"}`}>
